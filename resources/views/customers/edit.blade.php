...
<head>
    <meta charset="UTF-8">
    <title>Edit Customer | E-Invoice</title>
        ...
        <main class="p-6 max-w-4xl mx-auto w-full fade-in space-y-6">
            ...
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-gray-800 flex items-center gap-2">
                    <i data-lucide="user-cog" class="text-indigo-600"></i>
                    Edit Customer
                </h1>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <form method="POST" action="/customers/update/{{ $customer->id }}" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            ...
                            >{{ $customer->customer_address }}</textarea>
                        </div>
                    </div>
